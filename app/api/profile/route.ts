...
export async function GET(request: NextRequest) {
  ...
  try { return NextResponse.json(await financialData.profile(parsed.data)); }
  catch { return NextResponse.json({ error: "Company profile is temporarily unavailable." }, { status: 502 }); }
}
