...
const SceneView = ({
  ...
  const topInset = isParentHeaderShown || Platform.OS === 'android' && unstable_headerInsets?.top === false || Platform.OS === 'ios' && isModal || isIPhone && isLandscape ? 0 : insets.top;
      ...
      children: /*#__PURE__*/_jsx(AnimatedHeaderHeightContext.Provider, {
        ...
        children: /*#__PURE__*/_jsxs(HeaderHeightContext.Provider, {
          ...
          _jsx(View, {
            ...
            style: [styles.header, headerTransparent ? [styles.absolute,
      ...
      children: state.routes.concat(state.preloadedRoutes).map((route, index) => {
        ...
        return /*#__PURE__*/_jsx(SceneView, {
          ...
          onDismissed: event => {
            ...
            const currentActiveRoutes = currentState.routes.slice(0, currentState.index + 1);
